...
public class Connection {
	...
	public DataInputStream accept2read() {
	...
	public DataOutputStream accept2write() {
	...
	public DataOutputStream connect2write(String ip, int port) {
		DataOutputStream dos = null;
		while (true) {
			try {
				Socket sc = new Socket(ip, port);
	...
	public DataInputStream connect2read(String ip, int port) {
		DataInputStream dis = null;
		while (true) {
			try {
				Socket sc = new Socket(ip, port);
